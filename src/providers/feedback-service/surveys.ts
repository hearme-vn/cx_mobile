...
class Survey {
    ...
    public needNotification() {
        ...
        if (this.notification && this.feedback && 
            ...
            this.notificationColor = this.feedback.rating;
        }
        return this.notification;
    }
...
class MainSurvey extends Survey implements SurveyINF {
    ...
    public updateFeedback(feedback) {
        ...
        // Notification
        if (this.feedback && this.feedback.rating <= this.RATING_THRESHOLD)  
            this.notification = true
        else 
            this.notification = false;
...
class NPS extends MainSurvey {
    ...
    public needNotification() {
        let ret = super.needNotification();
        if (ret)
            this.notificationColor = Math.round(this.feedback.rating / 2);
        return ret;
    }
}
...
class CES extends MainSurvey {
    ...
    public needNotification() {
        let ret = super.needNotification();
        if (ret)
            this.notificationColor = this.feedback.rating - 1;
        return ret;
    }
